...
<a href="#consulta" style="width: 100%;"><button id="guardarConsulta" style="height: 100%;" class="btn btn-success add col-sm-2" type="button" onclick="add_Consulta();">Guardar Consulta</button></a>
</div>
