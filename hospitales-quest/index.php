            ...
            <main class="container" id="main-content">
                <form action="includes/datos_recabados.php" id="form" method="post">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-2">
                            <input id="inicio_consultas" class="form-control" type="date" name="inicio_consultas">
                        </div>                        
                        <label class="col-sm-2 col-form-label" for="fin_consultas">a</label>
                        <div class="col-sm-2">
                            <input id="fin_consultas" class="form-control" type="date" name="fin_consultas">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <hr>                        
                        <div class="guardar">
                            <input type="submit"  id="saveAll" class="btn btn-success" style="text-align:center" name="submitTodo" value="Guardar Encuesta">                        </div>
